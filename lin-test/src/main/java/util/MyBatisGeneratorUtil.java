...
public class MyBatisGeneratorUtil {
    ...
    public static void generator(
        ...
        JdbcUtil jdbcUtil = new JdbcUtil(driver, jdbc_url, AESUtil.AESDecode2(password, "AES"), username);
        ...
        context.put("generator_jdbc_password",AESUtil.AESDecode2(password,"AES"));
